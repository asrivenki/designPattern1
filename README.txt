...
3)Import the jar files under the "JARS" folder into the project, if needed.
...
createStudentGrader is a singleton class. And it returns one instance of the class. This class is responsile to return the Grade object of the corresponding student type

The output type of the file is generated by the outputGrades function of calculateGrades.java .
